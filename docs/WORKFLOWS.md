...
- **Media type** — one of `BD25`, `BD50`, `BDXL100`, `MDISC25`, `MDISC100`,
  `LTO8`, `LTO9`, `TEST_TINY`, `TEST_SMALL`, `TEST_CD` (defined in
  `src/lcsas/config/media.py`). Optical types carry 15% ECC overhead; LTO
  carries 0%; `TEST_CD` labels render as `CD` on disc.
