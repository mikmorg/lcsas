...
> **STATUS: RESOLVED** — landed in `9579623` (boot: align menu-entry paths with the staged tree; drop phantom FreeBSD entries [BOOT-03]); guarded by `tests/unit/test_boot_config_paths.py`.
