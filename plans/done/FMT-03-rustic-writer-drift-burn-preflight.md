...
> **STATUS: RESOLVED** — landed in `587ab1a` (burn+config+ci: gate burns on pinned-reader format proof [FMT-03]); guarded by `tests/integration/test_burn_preflight_live.py`.
