...
> **STATUS: RESOLVED** — landed in `ab641d8` (boot+test: quarantine tripwire + QEMU boot-smoke revival spec [BOOT-08]); guarded by `tests/recovery_hardening/test_boot_path_quarantined.py`.
