...
> **STATUS: RESOLVED** — landed in `d2dbfa1` (recovery: depth-cap tree walk + fuzz lcsas_tree_restore [T1C-04]); guarded by `tests/recovery_hardening/test_tier1_deep_tree.py`.
