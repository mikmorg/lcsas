...
> **STATUS: RESOLVED** — landed in `6be886e` (recovery+ci: commit x86_64-macos tier-1 binary; gate git-tracked status [GATE-01]); guarded by `tests/recovery_hardening/test_tier1_macos_native.py + .github/workflows/test.yml`.
