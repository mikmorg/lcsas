...
> **STATUS: RESOLVED** — landed in `68c1079` (cli: route skipped discs into alternates retry; name volume labels in errors [RST-07]); guarded by `tests/unit/test_restore_from_disc.py`.
