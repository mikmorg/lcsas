...
> **STATUS: RESOLVED** — landed in `445d912` (test(blind): promote tier1-missing out of the XFAIL ledger [GATE-06]); guarded by `tests/recovery_hardening/test_restore_sh_tier1_missing_multidisc.py`.
