...
> **STATUS: RESOLVED** — landed in `f844930` (restore: gate blob decompression on index uncompressed_length, not magic sniff [RST-02]); guarded by `tests/unit/test_restic_fallback.py`.
