...
> **STATUS: RESOLVED** — landed in `81140c9` (ci+recovery: fail-closed coverage check, CI threshold to measured floor [GATE-07]); guarded by `tests/unit/test_coverage_check_fail_closed.py`.
