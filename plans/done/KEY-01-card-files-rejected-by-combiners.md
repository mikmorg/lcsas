...
> **STATUS: RESOLVED** — landed in `b5fd7b2` (keyshare: accept real share-card files in all three combiners [KEY-01]); guarded by `tests/integration/test_keyshare_binary_cards.py`.
