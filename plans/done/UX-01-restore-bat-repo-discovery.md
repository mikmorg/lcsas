...
> **STATUS: RESOLVED** — landed in `387eb10` (test: match restore.bat's improved missing-backup-set message [UX-01]); guarded by `tests/unit/test_restore_bat_dispatcher.py`.
