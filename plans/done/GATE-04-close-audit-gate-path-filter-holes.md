...
> **STATUS: RESOLVED** — landed in `e0cdd1e` (ci+tests: broaden audit-gate path filter + always-on C smoke [GATE-04]); guarded by `tests/recovery_hardening/test_workflow_path_filter.py`.
