...
> **STATUS: RESOLVED** — landed in `bab7442` (burn: retain session ISOs until clean; unbreak multi-location re-burn [BURN-06]); guarded by `tests/unit/test_session_pipeline.py`.
