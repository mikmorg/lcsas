...
> **STATUS: RESOLVED** — landed in `cc2f893` (db+test: volume-copy UPSERT never destroys verification evidence [FMA-04]); guarded by `tests/unit/test_db_volume_copies.py`.
