...
> **STATUS: RESOLVED** — landed in `023e697` (recovery: hard-fail initramfs build on missing sources [BOOT-02]); guarded by `tests/recovery_hardening/test_initramfs_manifest_sources.py`.
