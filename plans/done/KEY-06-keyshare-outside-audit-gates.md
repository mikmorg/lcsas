...
> **STATUS: RESOLVED** — landed in `704686c` (recovery+ci: bring lcsas-keyshare under coverage/fuzz/audit gates [KEY-06]); guarded by `tests/recovery_hardening/test_tier1_macos_native.py`.
