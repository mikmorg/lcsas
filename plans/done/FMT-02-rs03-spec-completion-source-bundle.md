...
> **STATUS: RESOLVED** — landed in `d8e87a2` (meta+docs+recovery: complete RS03 spec; pin+bundle dvdisaster source [FMT-02]); guarded by `tests/integration/test_rs03_doc_conformance.py`.
