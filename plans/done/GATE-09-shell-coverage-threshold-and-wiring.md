...
> **STATUS: RESOLVED** — landed in `23971b1` (ci+tests: enforce restore.sh shell-coverage floor; wire into gate + CI [GATE-09]); guarded by `tests/recovery_hardening/test_shell_coverage_contract.py`.
