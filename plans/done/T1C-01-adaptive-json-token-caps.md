...
> **STATUS: RESOLVED** — landed in `1e6a726` (recovery: size-adaptive tier-1 JSON parsing; never skip an index silently [T1C-01]); guarded by `tests/recovery_hardening/test_tier1_wide_directory.py`.
