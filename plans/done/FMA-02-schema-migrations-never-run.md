...
> **STATUS: RESOLVED** — landed in `d03b7f6` (db+cli: ensure_schema choke point — auto-migrate, refuse future schemas [FMA-02]); guarded by `tests/unit/test_burn_orchestrator.py`.
