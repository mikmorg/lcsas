...
> **STATUS: RESOLVED** — landed in `d496aff` (docs+staging: temper M-DISC claims, disclose BDXL drive requirement [FMT-07]); guarded by `tests/unit/test_disc_care_media_guidance.py`.
