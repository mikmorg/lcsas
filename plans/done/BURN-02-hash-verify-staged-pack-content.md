...
> **STATUS: RESOLVED** — landed in `a0d034d` (burn: hash-verify every staged pack against its catalog SHA-256 [BURN-02]); guarded by `tests/integration/test_catalog_validate_content.py`.
