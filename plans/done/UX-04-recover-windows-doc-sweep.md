...
> **STATUS: RESOLVED** — landed in `7e3bb94` (docs(recovery): sweep RECOVER_WINDOWS.txt paths + restorer commands [UX-04]); guarded by `tests/unit/test_doc_command_contract.py`.
