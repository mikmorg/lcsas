...
> **STATUS: RESOLVED** — landed in `66a0a4f` (burn+staging: durable receipts beside the catalog; disclose self-stale on-disc catalog [BURN-08]); guarded by `tests/unit/test_holographic_catalog_freshness.py`.
