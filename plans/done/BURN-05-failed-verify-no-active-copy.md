...
> **STATUS: RESOLVED** — landed in `4c74bde` (burn+db+cli: failed verify records no copy; session ends PARTIAL [BURN-05]); guarded by `tests/unit/test_location_queries.py`.
