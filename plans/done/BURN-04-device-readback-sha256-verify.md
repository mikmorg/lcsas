...
> **STATUS: RESOLVED** — landed in `16e0cc9` (burn+db+cli: VERIFIED requires device read-back matching the ISO SHA-256 [BURN-04]); guarded by `tests/unit/test_burn_device_verify.py`.
