...
> **STATUS: RESOLVED** — landed in `54f20bf` (docs+tests: correct inflated ~30% ECC repair-capacity claims [FMT-06]); guarded by `tests/recovery_hardening/test_ecc_capacity_claims.py`.
