...
> **STATUS: RESOLVED** — landed in `6ee4717` (restore: lower standalone restorer to true Python 3.10 floor [RST-09]); guarded by `tests/unit/test_standalone_subprocess.py`.
