...
> **STATUS: RESOLVED** — landed in `f52f0da` (tests: tolerate missing upstream recovery cache in windows fixture [INFRA-01]); guarded by `tests/unit/test_restore_bat_dispatcher.py`.
