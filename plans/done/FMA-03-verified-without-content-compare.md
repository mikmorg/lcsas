...
> **STATUS: RESOLVED** — landed in `4795d20` (iso+burn+db+cli: verify checks disc identity; evidence survives rebuild [FMA-03]); guarded by `tests/unit/test_db_volume_copies.py`.
